    ...
    <div className="min-h-screen bg-green-50">
      ...
      <nav className="bg-green-600 text-white p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            <Link href="/FarmerForm" className="hover:text-green-200">
              Crop Prediction
            </Link>
      ...
      <div className="bg-green-600 py-16 px-4 text-center text-white relative overflow-hidden">
        <div className="container mx-auto relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            KisaanMitra Crop Prediction
          </h1>
          <p className="text-xl max-w-3xl mx-auto mb-8">
            Making farming smarter with AI-powered crop recommendations based on
            soil, weather, and location data
          </p>
        </div>
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="text-gray-700 mb-6 text-center max-w-4xl mx-auto">
          <p className="text-lg">
            KisaanMitra provides AI-powered crop recommendations based on{" "}
            <span className="font-semibold">soil conditions</span>,
            <span className="font-semibold"> local weather patterns</span>, and{" "}
            <span className="font-semibold">geographical data</span>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mt-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="text-lg">
                  Enter your farm location and soil parameters:
                </p>
        ...
        {/* Features */}
        <div className="mt-16">
          <h3 className="text-2xl font-bold text-center text-green-700 mb-10">
            Key Features
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Get crop recommendations based on soil, weather, and local
                farming patterns
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Access comprehensive database of crops, including growing
                techniques and market demand
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Educational content and tutorials to help farmers implement
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Join thousands of farmers across India who are using KisaanMitra
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p>
                Empowering farmers with technology and data-driven insights for
